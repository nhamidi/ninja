...
set title "Simulation for 159985 octets file with ${perte[$k]} % of lost and a RTT=1sec"
set ylabel "Overhead (in %)"
set xlabel 'Redundancy Ratio in %'
set autoscale x
set autoscale y
plot '/home/tai/workspace/stage_pfe/bin/result_1/graph/_false_perte_de_${perte[$k]}_graph_over_head_pourcent.txt' using 1:2:3 notitle with yerrorbars, '/home/tai/workspace/stage_pfe/bin/result_1/graph/_false_perte_de_${perte[$k]}_graph_over_head_pourcent.txt' using 1:2:3 title 'Over-head' w l, '/home/tai/workspace/stage_pfe/bin/result_1/graph/_${perte[$k]}_graph_theo.txt' using 1:2:3 notitle with yerrorbars, '/home/tai/workspace/stage_pfe/bin/result_1/graph/_${perte[$k]}_graph_theo.txt' using 1:2:3 title 'Minimun lost' w l
EOF
...
set autoscale x
set yrange [0:7]
plot '/home/tai/workspace/stage_pfe/bin/result_1/graph/_false_perte_de_${perte[$k]}_graph_ack.txt' using 1:2:3 with yerrorbars notitle, '/home/tai/workspace/stage_pfe/bin/result_1/graph/_false_perte_de_${perte[$k]}_graph_ack.txt' using 1:2:3 title 'Nb of ack' w l

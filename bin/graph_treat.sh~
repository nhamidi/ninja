...
for ((j=0 ; j<10 ; j++))
	do 
	num=`echo "$(cat $current_file/$result_file/resultat_bis_${perte[$k]}_${historic[0]}_$j.txt | wc -l)"`
...
set autoscale x
set autoscale y
plot '/home/tai/workspace/stage_pfe/bin/graph/_${historic[0]}_perte_de_${perte[$k]}_graph_over_head_pourcent.txt' using 1:2:3 notitle with yerrorbars, '/home/tai/workspace/stage_pfe/bin/graph/_${historic[0]}_perte_de_${perte[$k]}_graph_over_head_pourcent.txt' using 1:2:3 title 'Over-head' w l, '/home/tai/workspace/stage_pfe/bin/graph/_${perte[$k]}_graph_theo.txt' using 1:2:3 notitle with yerrorbars, '/home/tai/workspace/stage_pfe/bin/graph/_${perte[$k]}_graph_theo.txt' using 1:2:3 title 'Minimun lost' w l
EOF
...
set autoscale x
set autoscale y
plot '/home/tai/workspace/stage_pfe/bin/graph/_${historic[0]}_perte_de_${perte[$k]}_graph_delay_ref.txt' using 1:2:3 notitle with yerrorbars, '/home/tai/workspace/stage_pfe/bin/graph/_${historic[0]}_perte_de_${perte[$k]}_graph_delay_ref.txt' using 1:2:3 title 'Experimental delay' w l 

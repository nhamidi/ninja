...
public class Encoder {
	...
	/*
	 * TODO Optimiza��o: ao inves de percorrer isto todas as vezes, ver s� as linhas quer perderam um non-zero, e subtrair ao 'r' original. Como lidar com
	...
	while (i + u != L) {
		...
		if ( minDegree == 2 ) {
		    ...
		    /*
		     * TODO Optimiza�ao: - tentar fazer sem este while... nao ha de ser dificil - j� procurei, e ha algoritmos optimizados para achar connected
		     * components � s� depois ver qual o maior...
		     */
